...
package com.haoxi.xgn.zxing.android;
...
import com.haoxi.xgn.zxing.decode.DecodeThread;
import com.haoxi.xgn.zxing.view.ViewfinderResultPointCallback;
	...
	public void handleMessage(Message message) {
		switch (message.what) {
			...
			case R.id.decode_succeeded:
				...
				//第三个参数可以返回扫描的图片，但是7.0出现问题，有待研究
				//activity.handleDecode((Result) message.obj, barcode, scaleFactor);
				activity.handleDecode((Result) message.obj, null, scaleFactor);
				break;
