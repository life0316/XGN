...
public class CustomDialog extends Dialog implements View.OnClickListener {
    ...
    private void init() {
        ...
        TextView tvMsg = view.findViewById(R.id.confirm_dialog_msg);
        TextView tvConfirm = view.findViewById(R.id.confirm_dialog_confirm);
        TextView tvCancel = view.findViewById(R.id.confirm_dialog_cancel);
