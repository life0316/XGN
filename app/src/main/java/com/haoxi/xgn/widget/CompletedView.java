...
public class CompletedView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(comTxt, mXCenter - mTxtWidth / 3, mYCenter - mTxtHeight * 1/2, mTextPaint);
        ...
        canvas.drawCircle(mXCenter - mRadius -mStrokeWidth  * 1/3, mYCenter - 3/2 *mStrokeWidth, mStrokeWidth * 1/3, mCirclePaint);
    }
